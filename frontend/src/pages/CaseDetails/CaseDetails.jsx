...
const CaseDetails = () => {
  ...
  const allcasedetailss = async () => {
    ...
    try {
      ...
      setappdate(resss.data[0].appointmentdate);
      console.log(resss.data[0].appointmentdate);
      settoken(resss.data[0].token);
      console.log(ress.data.caseDetails[0].lspid);
      setlid(ress.data.caseDetails[0].lspid);
      handleLoginn(ress.data.caseDetails[0].lspid);
    } catch (error) {
      console.error("Error in server", error);
    }
  };

  const handleLoginn = async (lspid) => {
    console.log(lspid);
    try {
    ...
    <div>
      ...
      <div className="pa">
        ...
        <div>
          ...
          <h1>Appointment Date : {appdate}</h1>
