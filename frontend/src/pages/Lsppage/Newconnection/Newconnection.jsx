...
const Newconnection = () => {
  ...
  const handlecasedetails = async (id) => {
    try {
      ...
      const userIds = response.data.caseDetails.map((detail) => detail.userid);
      console.log(userIds);
      await getuserdetailss(userIds);
